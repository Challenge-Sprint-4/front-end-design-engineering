    ...
    <header className="bg-white text-black shadow-md relative w-full">
      <nav className="w-full max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 relative">
        <Link to="/" className="text-2xl font-bold z-10">
          <img
            src={LogoTRH}
            alt="Logo da equipe do projeto"
            className="h-16 sm:h-18 md:h-20 lg:h-24 xl:h-28"
          />
        </Link>
        ...
        <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 items-center space-x-3">
          ...
          <Link to="/Contato" className="hover:text-blue-500 transition-colors">
            Contato
          </Link>
          <span className="text-gray-400">|</span>
          ...
          <span className="text-gray-400">|</span>
          <Link to="/Equipe" className="hover:text-blue-500 transition-colors">
            Equipe
          </Link>
          <span className="text-gray-400">|</span>
          <Link to="/Tutorial" className="hover:text-blue-500 transition-colors">
            Tutorial
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-4 z-10">
          {loading ? (
            ...
            <button
              ...
              className="flex items-center space-x-2 text-gray-800 hover:text-blue-500 transition-colors cursor-pointer"
            >
          ...
          <button
            ...
            className="text-gray-800 md:hidden focus:outline-none cursor-pointer"
          >
            <svg
              className="w-6 h-6"
              fill="none"
