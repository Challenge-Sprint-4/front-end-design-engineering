  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-12 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link to="/consultas" className="block p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow">
          <h2 className="text-2xl font-semibold text-blue-800 mb-2">Registrar Consultas</h2>
          <p className="text-gray-600">Registrar diagnósticos e prescrições.</p>
        </Link>
